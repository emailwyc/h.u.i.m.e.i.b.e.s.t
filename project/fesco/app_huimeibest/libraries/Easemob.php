...
class Easemob
{
    ...
    public function __construct() {
            ...
            $this->client_id =  config_item("global_hx_appkey");
            $this->client_secret = config_item("global_hx_cli_secret");
            $this->org_name =  config_item("global_hx_orgname");
            $this->app_name =  config_item("global_hx_appname");
    }
