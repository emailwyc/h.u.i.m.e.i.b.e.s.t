...
function ajaxdata(data,type){
	...
	if(type==1){
		...
		if(data[i].service_provided.consult.on)
		{
			str+="<div class=\"twzx line\"><a href=\""+zxurl+data[i]._id.$id+"\" class=\"cy1\"><img src=\"/ui/images/ico3-1.png\" alt=\"\" /><span> <em>已开通</em></span></a></div>";
		} else {
			str+="<div class=\"twzx line\"><a href=\"jvascript:void:(0)\" class=\"ch4\"><img src=\"/ui/images/ico3-11.png\" alt=\"\" /><span> <em>未开通</em></span></a></div>";
		}
		if('phonecall' in data[i].service_provided) {
			if(data[i].isph=="1"){
				str+="<div class=\"dhzx line\"><a href=\""+zxurl+data[i]._id.$id+"\" class=\"cb1\"><img src=\"/ui/images/ico3-3.png\" alt=\"\" /><span> <em>未满</span></a></div>";
			}else{
				str+="<div class=\"dhzx line\"><a href=\"javascript:void(0);\" class=\"ch4\"><img src=\"/ui/images/ico3-31.png\" alt=\"\" /><span> <em>已满</em></span></a></div>";
			}
		} else {
			str+="<div class=\"dhzx line\"><a href=\"javascript:void(0);\" class=\"ch4\"><img src=\"/ui/images/ico3-31.png\" alt=\"\" /><span> <em>已满</em></span></a></div>";
		}

		/*if(data[i].service_provided.clinic.on) {
			if(data[i].issub=="1"){
				str+="<div class=\"yygh\"><a href=\""+zxurl+data[i]._id.$id+"\" class=\"cg1\"><img src=\"/ui/images/ico3-2.png\" alt=\"\" /><span> <em>未满</span></a></div>";
			}else{
				str+='<a href="javascript:void(0);" class="ch4"><img src="/ui/images/ico3-21.png" alt="" /><span> <em>已满</em></span></a>';
			}
		} else {
			str+="<div class=\"yygh\"><a href=\"jvascript:void:(0)\" class=\"ch4\"><img src=\"/ui/images/ico3-21.png\" alt=\"\" /><span> <em>已满</em></span></a></div>";
		}*/
		str+="</div></div>";
		return str;	
		return false;
