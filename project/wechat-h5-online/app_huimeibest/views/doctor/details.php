    ...
    <div class="ys-con">
      ...
      <div class="item zjfw">
        ...
        <div class="btn cfix">
          ...
          <div class="twzx"><a href="/consult/index/<?=@$doctor['_id']?>"><p><img src="/ui/images/ico2-1.png" alt="" /><span>图文咨询</span><em>已开通</em></p></a></div>
          <?php }else{?>
          <div class="twzx no"><a href="javascript:void(0)"><p><img src="/ui/images/ico2-1.png" alt="" /><span>图文咨询</span><em>未开通</em></p></a></div>	
          <?php }?>
          ...
          <div class="dhzx no"> <a href="javascript:void(0)"><p><img src="/ui/images/ico2-3.png" alt="" /><span>电话咨询</span><em>已满</em></p></a> </div>
          <?php }?>
          <?php if($doctor['service_provided']['clinic']['on']){?>
              <?php if($isSub){?>
                  <!--div class="yygh"><a href="/subscribe/index/<?=@$doctor['_id']?>"><p><img src="/ui/images/ico2-2.png" alt="" /><span>预约加号</span><em>未满</em></p></a></div-->
              <?php }else{?>
                  <!--div class="yygh no"><a href="javascript:void(0)"><p><img src="/ui/images/ico2-2.png" alt="" /><span>预约加号</span><em>已满</em></p></a></div-->	
              <?php }?>
          <?php }else{?>
           <!--div class="yygh no"><a href="javascript:void(0)"><p><img src="/ui/images/ico2-2.png" alt="" /><span>预约加号</span><em>已满</em></p></a></div-->	
          <?php }?>
      ...
      <a href="/doctor/article/<?=@$doctor['_id']?>" class="item jj">
          <div class="tit arrow">
            <img src="/ui/images/ico4-8.png" alt="" /><span>文章</span>
          </div>
          <div class="con">
            点击右上角关注医生，订阅文章，获得更多健康知识
          </div>
      </a>
      <div class="item pl">
        <div class="tit">
