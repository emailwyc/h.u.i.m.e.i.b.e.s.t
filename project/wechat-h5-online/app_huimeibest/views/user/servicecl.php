...
<div class="jzjl-tit bt">
  <div>
    <a href="/user/service">图文咨询</a>
    <a href="/user/servicepc">电话咨询</a>
    <a href="javascript:void(0);" class="cur">预约加号</a>
  </div>
</div>
...
$(function(){
	myScroll.on("scrollEnd",function(){
		...
		{
			if(loadnum==10) {
				ajaxurl="/user/servicecl/1?p="+page;
				ajaxlist(ajaxurl,ajaxdata,myScroll,page,"5");
			}
		}
	})
	ajaxurl="/user/servicecl/1?p="+page;
