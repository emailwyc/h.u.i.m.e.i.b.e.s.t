...
class JsApi_pub extends Common_util_pub
{
	...
	function getUserInfo()
	{
		...
		//获取用户信息
		$url_userinfo = "https://api.weixin.qq.com/cgi-bin/user/info?access_token=".$data['access_token']."&openid=".$data['openid']."&lang=zh_CN";
        $userInfo = httpRequest($url_userinfo);
		$output = json_decode($userInfo, true);
		$ret['userinfo'] = $output;
		return $ret;
	}
